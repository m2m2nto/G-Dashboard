        ...
        <table className="min-w-full text-sm">
          <thead>
            <tr className="bg-surface-dim text-on-surface-secondary text-left border-b border-surface-border">
              ...
              <th className="px-3 py-2 text-xs font-medium sticky top-0 z-10 bg-surface-dim">CF Category</th>
        ...
        <thead>
          ...
          <tr className="bg-surface-dim text-on-surface-secondary text-left border-b border-surface-border">
            {[
              ...
              { key: 'category', label: 'CF Category', align: 'left' },
